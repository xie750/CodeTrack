...
TEST_CASES = [
    ...
    ('T18', '后端回归', 'pytest backend/tests', '21 passed；无失败用例', '通过'),
]
...
def build_connected():
    ...
    add_table(doc, ['指标', '结果', '说明'], [
        ...
        ('后端自动化测试', '21/21 通过', 'pytest backend/tests -q'),
