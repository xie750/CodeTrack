    ...
    <section>
      ...
      {!loggedIn ? <>
        ...
        <div className="exact-entry-grid">
          <article>
            <img src="/ui-assets/portal-teaching.png" alt="教学工作台" />
            <Title level={3}>教学工作台</Title>
            <Paragraph>进入课程管理、班级组织、任务发布与学情分析</Paragraph>
            <Button type="primary" size="large" onClick={onEnter}>进入工作台 <ArrowRight size={15} /></Button>
          </article>
          <article>
            <img src="/ui-assets/portal-research.png" alt="科研入口" />
            <Title level={3}>科研入口</Title>
            <Paragraph>论文阅读、代码复现与科研协作空间</Paragraph>
