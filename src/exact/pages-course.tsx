    ...
    <div className="workspace-board">
      ...
      <section className="exact-block workspace-panel workspace-materials">
        ...
        <div className="workspace-material-summary">
          <div className="material-donut"><ResponsiveContainer width={128} height={128}><PieChart><Pie data={materialChart} dataKey="value" innerRadius={39} outerRadius={56} paddingAngle={materialTotal ? 2 : 0}>{materialChart.map((item) => <Cell key={item.label} fill={item.color} />)}</Pie></PieChart></ResponsiveContainer><span><strong>{materialTotal}</strong><small>总资料数</small></span></div>
