...
def seed_demo_data(db: Session) -> None:
    ...
    demo_agent_runs = {
        "run_demo_ai_tutor_0901": {
            "student_id": "user_student_001",
            "course_id": "course_ds_001",
            "workflow_type": "student_ai_tutor_chat",
            "status": "SUCCEEDED",
            "input_json": json.dumps({"message": "链表头节点删除为什么要返回新 head？"}, ensure_ascii=False),
            "output_json": json.dumps({"confidence": 0.86, "source_used": True, "citation_count": 2}, ensure_ascii=False),
            "model_provider": "OPENAI_COMPATIBLE",
            "model_name": "course-data-structure-v2.0",
            "prompt_version": "student_ai_tutor_v0.1",
            "attempts": 1,
            "token_prompt": 840,
            "token_completion": 260,
            "started_at": datetime(2026, 9, 1, 9, 12, tzinfo=timezone.utc),
            "finished_at": datetime(2026, 9, 1, 9, 12, 2, 180000, tzinfo=timezone.utc),
        },
        "run_demo_diagnosis_0901": {
            "student_id": "user_student_001",
            "course_id": "course_ds_001",
            "workflow_type": "code_diagnosis_coach",
            "status": "SUCCEEDED",
            "input_json": json.dumps({"task_id": "task_linked_list_delete_001"}, ensure_ascii=False),
            "output_json": json.dumps({"confidence": 0.78, "source_used": True, "citation_count": 3}, ensure_ascii=False),
            "model_provider": "MODEL_GATEWAY",
            "model_name": "course-data-structure-v2.0",
            "prompt_version": "diagnosis_v0.1",
            "attempts": 1,
            "token_prompt": 1260,
            "token_completion": 420,
            "started_at": datetime(2026, 9, 1, 14, 20, tzinfo=timezone.utc),
            "finished_at": datetime(2026, 9, 1, 14, 20, 3, 540000, tzinfo=timezone.utc),
        },
        "run_demo_python_0902": {
            "student_id": "user_student_001",
            "course_id": "course_network_001",
            "workflow_type": "student_resource_generation",
            "status": "SUCCEEDED",
            "input_json": json.dumps({"resource_type": "KNOWLEDGE_CARD"}, ensure_ascii=False),
            "output_json": json.dumps({"confidence": 0.82, "source_used": True, "citation_count": 2}, ensure_ascii=False),
            "model_provider": "WORKFLOW",
            "model_name": "LangGraph + 知识卡片渲染器",
            "prompt_version": "resource_v0.1",
            "attempts": 1,
            "token_prompt": 980,
            "token_completion": 520,
            "started_at": datetime(2026, 9, 2, 10, 5, tzinfo=timezone.utc),
            "finished_at": datetime(2026, 9, 2, 10, 5, 5, 100000, tzinfo=timezone.utc),
        },
        "run_demo_ml_0903": {
            "student_id": "user_student_001",
            "course_id": "course_arch_001",
            "workflow_type": "student_ai_tutor_chat",
            "status": "SUCCEEDED",
            "input_json": json.dumps({"message": "过拟合和正则化怎么区分？"}, ensure_ascii=False),
            "output_json": json.dumps({"confidence": 0.72, "source_used": True, "citation_count": 1}, ensure_ascii=False),
            "model_provider": "OPENAI_COMPATIBLE",
            "model_name": "course-machine-learning-v3.1",
            "prompt_version": "student_ai_tutor_v0.1",
            "attempts": 1,
            "token_prompt": 760,
            "token_completion": 310,
            "started_at": datetime(2026, 9, 3, 16, 40, tzinfo=timezone.utc),
            "finished_at": datetime(2026, 9, 3, 16, 40, 2, 700000, tzinfo=timezone.utc),
        },
        "run_demo_ds_failed_0904": {
            "student_id": "user_student_002",
            "course_id": "course_ds_001",
            "workflow_type": "student_ai_tutor_chat",
            "status": "FAILED",
            "input_json": json.dumps({"message": "二叉树递归出口怎么写？"}, ensure_ascii=False),
            "output_json": "{}",
            "model_provider": "OPENAI_COMPATIBLE",
            "model_name": "course-data-structure-v2.0",
            "prompt_version": "student_ai_tutor_v0.1",
            ...
            "token_prompt": 0,
            "token_completion": 0,
            "started_at": datetime(2026, 9, 4, 20, 10, tzinfo=timezone.utc),
            "finished_at": datetime(2026, 9, 4, 20, 10, 12, 300000, tzinfo=timezone.utc),
        },
        "run_demo_ds_low_conf_0905": {
            "student_id": "user_student_002",
            "course_id": "course_ds_001",
            "workflow_type": "code_diagnosis",
            "status": "SUCCEEDED",
            "input_json": json.dumps({"task_id": "task_stack_queue_preview_001"}, ensure_ascii=False),
            "output_json": json.dumps({"confidence": 0.44, "source_used": False, "citation_count": 0}, ensure_ascii=False),
            "model_provider": "MODEL_GATEWAY",
            "model_name": "course-data-structure-v2.0",
            "prompt_version": "diagnosis_v0.1",
            "attempts": 1,
            ...
            "started_at": datetime(2026, 9, 5, 8, 26, tzinfo=timezone.utc),
            "finished_at": datetime(2026, 9, 5, 8, 26, 1, 920000, tzinfo=timezone.utc),
        },
    }
