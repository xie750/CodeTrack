...
class Settings(BaseSettings):
    ...
    openmaic_node_command: str = Field(default="node")
    openmaic_generation_timeout_seconds: int = Field(default=1200, ge=60, le=3600)
    openmaic_model_timeout_seconds: int = Field(default=180, ge=10, le=600)
    fine_tuned_model_api_key: str | None = Field(default=None)
    fine_tuned_model_api_base_url: str | None = Field(default=None)
    fine_tuned_model_name: str | None = Field(default=None)
