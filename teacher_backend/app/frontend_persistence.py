...
def ensure_frontend_persistence_seed(db: Session) -> None:
    ...
    if db.get(Course, "course-ds") and db.get(CourseAnnouncement, "announcement-tree-materials") is None:
        ...
        rows = [
            ...
            ("announcement-assignment-reminder", "第33次作业《线性表4组》提交截止提醒", "截止时间：2026-05-31 23:59，请按时提交。", ["第33次作业《线性表4组》将于 2026年5月31日 23:59 截止提交，请尚未完成的同学合理安排时间。", "提交前请确认代码能够通过公开测试用例，并在报告中简要说明时间复杂度。"], "人工智能 1 班、人工智能 2 班", False, datetime(2026, 5, 27, 16, 10)),
            ...
            ("announcement-lab-room", "本周实验课教室临时调整", "周四实验课调整至信息楼 A305，请相互转告。", ["因原实验室设备维护，本周四第5-6节实验课临时调整至信息楼 A305，授课时间不变。", "请提前十分钟到达并按照班级座位表入座。下周起恢复原实验室上课。"], "人工智能实验班", False, datetime(2026, 5, 24, 18, 45)),
